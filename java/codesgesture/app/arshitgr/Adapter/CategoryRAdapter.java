...
import codesgesture.app.arshitgr.Activities.Restaurant.PageRestaurant;
...
public class CategoryRAdapter extends RecyclerView.Adapter<CategoryRAdapter.ViewHolder> {
    ...
    public CategoryRAdapter(Context context, ArrayList<CategoryModel> arrayList, int layout) {
    ...
    @Override
    public CategoryRAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(layout, parent, false);
        return new CategoryRAdapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(final CategoryRAdapter.ViewHolder holder, final int i) {
        ...
        holder.click_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ecb.OnCompleted(data.getCategory_id(),data.getCategory_name());
            }
        });
