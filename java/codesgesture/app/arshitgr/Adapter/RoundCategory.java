...
public class RoundCategory extends RecyclerView.Adapter<RoundCategory.ViewHolder> {
    ...
    public RoundCategory(Context context, ArrayList<CategoryModel> arrayList, int layout) {
