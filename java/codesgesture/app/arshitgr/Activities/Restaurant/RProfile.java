...
public class RProfile extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rprofile);
    ...
    private void UpdatePassword() {
        ...
        CallJson jc = new CallJson(RProfile.this);
        ...
        jc.SendRequest("update_password", param, new JsonCallbacks() {
            ...
            public void onPostSuceess(String json, String method) throws JSONException {
                UserUtil.ShowMsg("Password Updated !!",RProfile.this);
            }
            @Override
    ...
    private void SavePicture() {
        ...
        jc.SendRequest("update_picture", param, new JsonCallbacks() {
            @Override
            public void onPostSuceess(String json, String method) throws JSONException {
                UserUtil.ShowMsg("Picture Uploaded !!",RProfile.this);
            }
            @Override
            public void onPostError(String msg) {
    ...
    private void UpdateData() {
        ...
        jc.SendRequest("update_user", param, new JsonCallbacks() {
            @Override
            public void onPostSuceess(String json, String method) throws JSONException {
                UserUtil.ShowMsg("Details Updated !!",RProfile.this);
                ...
                try {
                    ...
                    Utility.ShowMEssage(RProfile.this, "Invalid OTP !");
                    e.printStackTrace();
                }
            }
            @Override
    ...
    private void BindDate() {
        ...
        txdob.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // date picker dialog
                datePickerDialog = new DatePickerDialog(RProfile.this,
    ...
    private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener) {
        new AlertDialog.Builder(RProfile.this)
                .setMessage(message)
