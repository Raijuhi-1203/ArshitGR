...
import codesgesture.app.arshitgr.Adapter.CancelOrderAdapter;
...
public class PageCancleOrder extends AppCompatActivity {
    RecyclerView recycler;
    LinearLayout norecord;
    CustomerModel customerModel;
    ArrayList<Order> orders=new ArrayList<>();
    CancelOrderAdapter orderAdapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        searchbar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(PageCancleOrder.this,PageSearchProduct.class));
            }
        });
        cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(PageCancleOrder.this, WishListFragment.class));
            }
        });
        person.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(PageCancleOrder.this, AccountFragment.class));
            }
        });

        GridLayoutManager mLayoutManager = new GridLayoutManager(PageCancleOrder.this, 1);
        recycler.setLayoutManager(mLayoutManager);
        orderAdapter = new CancelOrderAdapter(PageCancleOrder.this, orders, R.layout.item_order,"cancel");
    ...
    private void GetData() {
        ...
        CallJson jc = new CallJson(PageCancleOrder.this);
        param.add(new NetParam("customer_id",customerModel.getCustomer_id()));
        param.add(new NetParam("status","Cancelled"));
        jc.SendRequest("get_allorderstatus", param, new JsonCallbacks() {
            @Override
