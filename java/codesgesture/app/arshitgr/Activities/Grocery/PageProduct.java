...
public class PageProduct extends AppCompatActivity {
    ...
    String categoryModel,catnm;
    ProductAdapter productAdapter;
    RoundCategory categoryAdapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        categoryModel=getIntent().getStringExtra("data");
        ...
        catname.setText(catnm);

        GridLayoutManager mLayoutManager = new GridLayoutManager(PageProduct.this, 2);
        recycler.setLayoutManager(mLayoutManager);
        productAdapter = new ProductAdapter(PageProduct.this, productModels, R.layout.item_product, new Notify() {
            @Override
        ...
        categoryAdapter = new RoundCategory(PageProduct.this, category,R.layout.round_category);
        ...
        rvcat.setItemViewCacheSize(category.size());
        ...
        searchbar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(PageProduct.this,PageSearchProduct.class));
            }
        });
        cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(PageProduct.this, CartFragment.class));
            }
        });
        person.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(PageProduct.this, AccountFragment.class));
            }
        });
    ...
    private void GetData(String id) {
        ...
        param = new ArrayList<NetParam>();
        CallJsonWithoutProgress jc = new CallJsonWithoutProgress(PageProduct.this);
        param.add(new NetParam("category_id",id));
        param.add(new NetParam("customer_id",customerModel.getCustomer_id()));
