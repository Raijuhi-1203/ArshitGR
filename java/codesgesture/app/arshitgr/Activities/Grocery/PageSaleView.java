...
public class PageSaleView extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        GridLayoutManager mLayoutManager = new GridLayoutManager(PageSaleView.this, 2);
        recycler.setLayoutManager(mLayoutManager);
        productAdapter = new ProductAdapter(PageSaleView.this, productModels, R.layout.item_product, new Notify() {
            @Override
        ...
        searchbar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(PageSaleView.this,PageSearchProduct.class));
            }
        });
        cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(PageSaleView.this, CartFragment.class));
            }
        });
        person.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(PageSaleView.this, AccountFragment.class));
            }
        });
    ...
    private void BindCart() {
        ...
        CallJsonWithoutProgress jc = new CallJsonWithoutProgress(PageSaleView.this);
    ...
    private void GetData() {
        ...
        CallJsonWithoutProgress jc = new CallJsonWithoutProgress(PageSaleView.this);
        param.add(new NetParam("customer_id",customerModel.getCustomer_id()));
        jc.SendRequest("get_TopDeals_all", param, new JsonCallbacks() {
            @Override
            public void onPostSuceess(String json, String method) throws JSONException {
