...
public class PageRecentView extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        GridLayoutManager gridLayoutManager2 = new GridLayoutManager(PageRecentView.this, 2);
        recycler.setLayoutManager(gridLayoutManager2);
        productAdapter = new ProductAdapter(PageRecentView.this, productModels, R.layout.item_product, new Notify() {
            @Override
        ...
        searchbar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(PageRecentView.this,PageSearchProduct.class));
            }
        });
        cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(PageRecentView.this, CartFragment.class));
            }
        });
        person.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(PageRecentView.this, AccountFragment.class));
            }
        });
    ...
    private void BindCart() {
        ...
        CallJsonWithoutProgress jc = new CallJsonWithoutProgress(PageRecentView.this);
    ...
    private void GetData() {
        ...
        CallJsonWithoutProgress jc = new CallJsonWithoutProgress(PageRecentView.this);
        param.add(new NetParam("customer_id",customerModel.getCustomer_id()));
        jc.SendRequest("get_recentview_all", param, new JsonCallbacks() {
            @Override
            public void onPostSuceess(String json, String method) throws JSONException {
